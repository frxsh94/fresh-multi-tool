...
def option1():
    effacer_ecran()
    script_path = os.path.join(scripts_dir, "ddos_attack2.py")
    try:
...
def menu():
    while True:
        print_menu_header()
        print(f"{COLOR_STEPS[0]}{{1}}{RESET}       {COLOR_STEPS[1]}{{2}}{RESET}        {COLOR_STEPS[2]}{{3}}{RESET}        {COLOR_STEPS[3]}{{4}}{RESET}        {COLOR_STEPS[4]}{{5}}{RESET}")
        print(f"{COLOR_STEPS[0]}DDoS IP{RESET}   {COLOR_STEPS[1]}DM All{RESET}     {COLOR_STEPS[2]}IP Loc{RESET}   {COLOR_STEPS[3]}Numero loc{RESET}   {COLOR_STEPS[4]}Port Check{RESET}")
